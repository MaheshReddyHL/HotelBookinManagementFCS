...
{
    public class HotelRooms1Controller : Controller
    {
        ...
        // GET: HotelRooms1/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: HotelRooms1/Create
